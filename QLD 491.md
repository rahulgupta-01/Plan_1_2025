...
#### **📌 Understanding QSOL vs. LIN 19/051**
- The **Queensland Skilled Occupation List (QSOL)** is mainly for **offshore applicants** who are applying for state nomination.
- **For applicants currently in Queensland**, Migration Queensland refers to the broader **Department of Home Affairs' occupation list (LIN 19/051)**.
- **In short:** If you're an **onshore applicant**, your occupation only needs to be on **LIN 19/051**, while offshore applicants need to check **QSOL**.
