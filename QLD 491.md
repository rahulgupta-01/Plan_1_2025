...
- You **must live and work in a [designated regional area](https://immi.homeaffairs.gov.au/visas/working-in-australia/skill-occupation-list/regional-postcodes)** for at least **three years** before applying for PR ([Subclass 191](https://immi.homeaffairs.gov.au/visas/getting-a-visa/visa-listing/skilled-regional-191/regional-provisional)).
...
📌 To verify if your degree qualifies for the [Queensland Graduates Pathway](https://www.migration.qld.gov.au/visa-options/skilled-visas/graduates-of-a-queensland-university), visit the [CRICOS website](https://cricos.education.gov.au) and use the [Course Search](https://cricos.education.gov.au/Course/CourseSearch.aspx) feature; check that the 'Narrow Field' displayed matches one in the [priority field](https://www.migration.qld.gov.au/visa-options/skilled-visas/graduates-of-a-queensland-university#:~:text=What%20are%20the%20priority%20fields%20of%20study%20for%20the%20Queensland%20Graduates%20pathway%3F) list.
...
#### **📌 Understanding [QSOL](https://www.migration.qld.gov.au/occupation-lists) vs. [LIN 19/051](https://www.legislation.gov.au/F2019L00278/latest/text)**
- The **[Queensland Skilled Occupation List (QSOL)](https://www.migration.qld.gov.au/occupation-lists)** is mainly for **offshore applicants** applying for state nomination.  
- **Queensland Graduates and skilled workers already in Queensland** must refer to the **Department of Home Affairs’ occupation list ([LIN 19/051](https://www.legislation.gov.au/F2019L00278/latest/text))**, not [QSOL](https://www.migration.qld.gov.au/occupation-lists).  
- **In summary:**  
  - If you're an **offshore applicant**, check **[QSOL](https://www.migration.qld.gov.au/occupation-lists)**.  
  - If you're a **Queensland Graduate or an onshore skilled worker**, your occupation only needs to be on **[LIN 19/051](https://www.legislation.gov.au/F2019L00278/latest/text)**.

📌 **Note:**  
- **Queensland graduates** only need their occupation to be on **[LIN 19/051](https://www.legislation.gov.au/F2019L00278/latest/text)**, which **includes IT**.  
...
- The job must:
  ...
  - Be in a **[Skill Level 1](https://www.abs.gov.au/articles/how-anzsco-works#:~:text=Figure%202%20Structure%20of%20ANZSCO%20by%20skill%20level) occupation** (e.g., IT-related jobs).
...
- Your job must be **in a [Skill Level 1](https://www.abs.gov.au/articles/how-anzsco-works#:~:text=Figure%202%20Structure%20of%20ANZSCO%20by%20skill%20level) occupation**
