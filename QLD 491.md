...
- The **Queensland Skilled Occupation List (QSOL)** is mainly for **offshore applicants** applying for state nomination.  
- **Queensland Graduates and skilled workers already in Queensland** must refer to the **Department of Home Affairs’ occupation list ([LIN 19/051](https://www.legislation.gov.au/F2019L00278/latest/text))**, not QSOL.  
- **In summary:**  
  - If you're an **offshore applicant**, check **QSOL**.  
